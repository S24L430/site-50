...
## Environments
- Preview: https://main--site-50--s24l430.hlx.page/
- Live: https://main--site-50--s24l430.hlx.live/
- Custom Domain: https://site-50.impactful-3.site (Available during the lab)
...
WKND_URL=https://main--site-50--s24l430.hlx.live ITERATIONS=1000 npm run generate-traffic
```
